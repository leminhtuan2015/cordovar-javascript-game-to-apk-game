...
| --- | --- | --- |
| [<**vaadin-grid**>](https://github.com/vaadin/vaadin-grid) &middot; [Examples](https://cdn.vaadin.com/vaadin-core-elements/0.3.0/vaadin-grid/demo/) &middot; [API](https://cdn.vaadin.com/vaadin-core-elements/0.3.0/vaadin-grid/) | Data grid for showing large amounts of tabular data. | Beta |
...
- ##### CDN
 ...
 For example, to import vaadin-grid, use the following URL:
   ...
   `https://cdn.vaadin.com/vaadin-core-elements/0.3.0/vaadin-grid/vaadin-grid.html`

 To import all Vaadin Core Elements, use the following URL:

   `https://cdn.vaadin.com/vaadin-core-elements/0.3.0/vaadin-core-elements/vaadin-core-elements.html`
...
<html>
  <head>
    ...
    <!-- CDN -->
    <script src="https://cdn.vaadin.com/vaadin-core-elements/0.3.0/webcomponentsjs/webcomponents-lite.min.js"></script>
    <link href="https://cdn.vaadin.com/vaadin-core-elements/0.3.0/vaadin-core-elements/vaadin-core-elements.html" rel="import">
